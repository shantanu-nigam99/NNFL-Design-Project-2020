...
This is the [project presentation](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/NNFL%20Project%20Presentation.pdf).

## MODEL FILES
The [Main Model](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/ADRNN_Model_Final.ipynb)
is the Associated Deep Recurrent Neural Network model which predicts Open Price, Low Price and High Price of a Stock.
The [LSTM Model](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/LSTM_model_for_comparision.ipynb)
and 
[DRNN Model](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/DRNN_model_for_comparision.ipynb)
...
![IMAGE](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/Model%20Architecture.png)
...
We have arbitrarily taken Tata Motors (ISIN: INE155A01022) stock prices. The files are available in year wise data. 15 years of data is concatenated [here](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/tata_dataset.csv). The user may take any other stock price as well.
...
[tata_dataset.csv](https://github.com/shantanu-nigam99/NNFL-Design-Project-2020/blob/master/tata_dataset.csv)
